...
const ApparatusTab: React.FC<ApparatusTabProps> = ({ onItemSelect }) => {
  ...
  const apparatusItems: ApparatusItem[] = [
    { name: "Rotary Evaporator", image: rotavapImg, isCorrect: true },
    { name: "Round-bottomed Flask", image: rbFlaskImg, isCorrect: true },
    ...
    { name: "Keck Clips", image: keckClipImg, isCorrect: true },
    { name: "Eye Dropper", image: eyeDropperImg, isCorrect: false },
    { name: "Bump Trap", image: bumpTrapImg, isCorrect: true },
