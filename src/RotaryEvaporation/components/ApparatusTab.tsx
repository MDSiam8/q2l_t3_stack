...
import balanceImg from "../images/rotavap.png";
...
const ApparatusTab: React.FC<ApparatusTabProps> = ({ onItemSelect }) => {
  ...
  const apparatusItems: ApparatusItem[] = [
    { name: "Rotary Evaporator", image: balanceImg, isCorrect: true },
    { name: "Round-bottomed Flask", image: weighingPaper, isCorrect: true },
    ...
    { name: "Keck Clips", image: beakerImg, isCorrect: true },
    { name: "Bump Traps", image: spatulaImg, isCorrect: true },
