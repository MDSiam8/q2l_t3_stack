...
export function RotavapRemoveFlask(props: GroupProps) {
  const { scene, animations } = useGLTF("./16-remove rb.glb");
  ...
  const hitboxPosition: Vector3 = [0, 3.9, .2]; // Replace x, y, z with the coordinates near the power button
...
useGLTF.preload("./16-remove rb.glb");
