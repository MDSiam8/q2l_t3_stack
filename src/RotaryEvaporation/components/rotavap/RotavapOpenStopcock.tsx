...
export function RotavapOpenStopcock(props: GroupProps) {
  const { scene, animations } = useGLTF("./15-open stopcock.glb");
  ...
  const hitboxPosition: Vector3 = [0, 6.2, 4.9]; // Replace x, y, z with the coordinates near the power button
...
useGLTF.preload("./15-open stopcock.glb");
