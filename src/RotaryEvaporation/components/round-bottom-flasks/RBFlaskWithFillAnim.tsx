...
export function HundredMLFlaskWithFillAnimation({ startAnimationDelay = 0, ...props }: HundredMLFlaskWithFillAnimationProps) {
  ...
  return (
    <primitive {...props} object={clonedScene} scale={0.8} opacity={0.8} />
  );
}
