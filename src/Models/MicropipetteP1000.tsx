...
export const MicropipetteP1000Model = forwardRef<MicropipetteRef, MicropipetteProps>(
  (props: MicropipetteProps, ref) => {
    const micropipettep1000 = useGLTF(modelPath);

    const MicropipetteRef = useRef<any>();
    
    const animations = useAnimations(micropipettep1000.animations, micropipettep1000.scene);
    ...
    useImperativeHandle(ref, () => ({
      ...
      ...micropipettep1000.scene,
      ...MicropipetteRef.current,
    }));
    
    return (
      <group {...props} position={props.startingPosition}>
        <primitive object={micropipettep1000.scene} scale={props.scale * 1/3} />
