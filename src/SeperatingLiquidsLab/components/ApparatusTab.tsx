...
import rotavapImg from "../images/rotavap.png";
import rbFlaskImg from "../images/rb flask.png";
import keckClipImg from "../images/keck clip.png";
...
const ApparatusTab: React.FC<ApparatusTabProps> = ({ onItemSelect }) => {
  ...
  const apparatusItems: ApparatusItem[] = [
    { name: "Beaker", image: rotavapImg, isCorrect: true },
    { name: "Seperating Funnel", image: rbFlaskImg, isCorrect: true },
    ...
    { name: "Filter Funnel w/ Filter Paper", image: keckClipImg, isCorrect: true },
    { name: "Volumetric Flask", image: eyeDropperImg, isCorrect: false },
    { name: "Cuvette with Cap", image: bumpTrapImg, isCorrect: false },
    { name: "Stopper", image: bumpTrapImg, isCorrect: true },
