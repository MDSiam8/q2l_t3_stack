...
import { SeperatingFunnelVentAirAfterMixing } from "../seperating_funnel/SeperatingFunnelVentAirAfterMixing";
...
const Step8VentAirAfterMixing = forwardRef<HTMLDivElement, Step2LabTasksProps>(
  ({ nextButtonRef }, ref) => {
        ...
        <group rotation-y={Math.PI}>
          <SeparatingFunnelHolder position={[0, 5, 0]}>
            <group ref={funnelGroupRef}>
              <SeperatingFunnelVentAirAfterMixing
                position={[0.2, 5, 0.1]}
                scale={1.75}
                rotation-y={4.7}
                rotation-x={0}
...
export default Step8VentAirAfterMixing;
