...
export function BeakerPouringOrganicSolution({ startAnimationDelay = 0, ...props }: HundredMLFlaskWithFillAnimationProps) {
  const { scene, animations } = useGLTF("./beaker pouring orange solution.glb");
...
// beaker pouring orange solution.glb
useGLTF.preload("./beaker pouring orange solution.glb");
