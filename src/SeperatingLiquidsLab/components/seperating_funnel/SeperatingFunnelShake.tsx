...
export const SFunnelShaking = forwardRef<THREE.Object3D, SFunnelPouringOrganicLayerProps>(
  ({ startAnimationDelay = 0, ...props }, ref) => {
    const { scene, animations } = useGLTF("./WithArmature_Shaking.glb");
...
useGLTF.preload("./WithArmature_Shaking.glb");