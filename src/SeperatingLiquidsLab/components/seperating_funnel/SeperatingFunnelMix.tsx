...
interface BeakerWithWasteFillAnimationProps {
  ...
  export function SeperatingFunnelMix({ startAnimationDelay = 0, ...props }: BeakerWithWasteFillAnimationProps) {
    const { scene, animations } = useGLTF("./shaking.glb");
