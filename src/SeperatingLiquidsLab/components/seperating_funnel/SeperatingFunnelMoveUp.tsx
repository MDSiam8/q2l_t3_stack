...
export const SFunnelMoveUp = forwardRef<THREE.Object3D, SFunnelPouringOrganicLayerProps>(
  ({ startAnimationDelay = 0, ...props }, ref) => {
    const { scene, animations } = useGLTF("./FunnelAnimationTest.glb");
...
useGLTF.preload("./FunnelAnimationTest.glb");